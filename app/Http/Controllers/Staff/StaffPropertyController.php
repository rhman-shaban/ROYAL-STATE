...
class StaffPropertyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.property.index',compact('properties','settings','websiteLang'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.property.create',compact('propertyTypes','cities','purposes','aminities','websiteLang','nearest_locatoins'));
    }
    ...
    public function edit(Property $property)
    {
        ...
        $websiteLang=ManageText::all();
        $nearest_locatoins=NearestLocation::where('status',1)->get();
        return view('staff.property.edit',compact('property','propertyTypes','cities','purposes','aminities','websiteLang','nearest_locatoins'));
    }
