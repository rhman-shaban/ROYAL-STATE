...
@section('title')
<title>{{ $websiteLang->where('lang_key','banner_img')->first()->custom_text }}</title>
@endsection
        ...
        <div class="col-md-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','banner_img')->first()->custom_text }}</h6>
                </div>
                <div class="card-body">
