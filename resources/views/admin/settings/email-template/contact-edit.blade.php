                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $user_email }}</td>
                                <td>{{ $websiteLang->where('lang_key','user_email')->first()->custom_text }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $user_phone }}</td>
                                <td>{{ $websiteLang->where('lang_key','user_phone')->first()->custom_text }}</td>
                            </tr>
                            <tr>
                                @php
                                    $subject="{{subject}}";
                                @endphp
                                <td>{{ $subject }}</td>
                                <td>{{ $websiteLang->where('lang_key','msg_subject')->first()->custom_text }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $message }}</td>
                                <td>{{ $websiteLang->where('lang_key','msg')->first()->custom_text }}</td>
                            </tr>
