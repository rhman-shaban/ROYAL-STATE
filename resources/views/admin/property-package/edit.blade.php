                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="package_type" id="package_type" class="form-control">
                                        <option {{ $package->package_type==1 ? 'selected' :'' }} value="1">{{ $websiteLang->where('lang_key','premium')->first()->custom_text }}</option>
                                        <option {{ $package->package_type==0 ? 'selected' :'' }} value="0">{{ $websiteLang->where('lang_key','free')->first()->custom_text }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="feature" id="feature" class="form-control">
                                        <option {{ $package->is_featured==1 ? 'selected' :'' }}  value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_text }}</option>
                                        <option {{ $package->is_featured==0 ? 'selected' :'' }}  value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_text }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="top_property" id="top_property" class="form-control">
                                        <option {{ $package->is_top==1 ? 'selected' :'' }}  value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_text }}</option>
                                        <option {{ $package->is_top==0 ? 'selected' :'' }}  value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_text }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="urgent" id="urgent" class="form-control">
                                        <option {{ $package->is_urgent==1 ? 'selected' :'' }}  value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_text }}</option>
                                        <option {{ $package->is_urgent==0 ? 'selected' :'' }}  value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_text }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option {{ $package->status==1 ? 'selected' :'' }}  value="1">{{ $websiteLang->where('lang_key','yes')->first()->custom_text }}</option>
                                        <option {{ $package->status==0 ? 'selected' :'' }}  value="0">{{ $websiteLang->where('lang_key','no')->first()->custom_text }}</option>
                                    </select>
                                </div>
                            </div>
